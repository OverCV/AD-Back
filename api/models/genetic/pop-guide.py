...
#                 [STR_ONE if ci in dual_c else STR_ZERO for ci in current]
#             )
#             # Obtenemos la clave de inicialización
#             dual_cinit_key = EMPTY_STR.join(
#                 [initial_state[ci] for ci in dual_c]
#             )
...
#                 [STR_ONE if ci in primal_c else STR_ZERO for ci in current]
#             )
#             # Obtenemos la clave de inicialización
#             primal_cinit_key = EMPTY_STR.join(
#                 [initial_state[ci] for ci in primal_c]
#             )
#             # Almacenamos las series seleccionadas
#             for matrix in subtensor:
...
#                     mar_matrix = matrix.margin_row(
#                         cprimal_state_key, be=True
#                     )
#                     serie_primal.append(
#                         mar_matrix
